...
void pop_back() {
    ...
    checker(std_vec.size() == ft_vec.size());
    checker(std_vec.empty() == ft_vec.empty());
}
...
void assign() {
    ...
    std::vector<int> std_vec;
    ft::vector<int> ft_vec;
    int arr[] = {2, 10, 12, 72, 12, 10, 100};

    test_title("ASSIGN");

    start = clock();
    std_vec.assign(arr, arr + 6);
    end = clock();
    time(start, end);
    std_ticks = end - start;

    start = clock();
    ft_vec.assign(arr, arr + 6);
    end = clock();
    time(start, end);
    ft_ticks = end - start;
...
void insert() {
    ...
    std::cout << "******************1********************\n";
    start = clock();
    std_vec.insert(std_vec.begin(), std_buf.begin(), std_buf.end());
    end = clock();
    time(start, end);
    std_ticks = end - start;

    start = clock();
    ft_vec.insert(ft_vec.begin(), ft_buf.begin(), ft_buf.end());
    end = clock();
    time(start, end);
    ft_ticks = end - start;
    ...
    start = clock();
    ft_vec.insert(ft_vec.begin(), ITERATIONS, 10);
    end = clock();
    time(start, end);
    ft_ticks = end - start;
    ...
    start = clock();
    std_vec.insert(std_it, buffer.begin(), buffer.end());
    end = clock();
    time(start, end);
    std_ticks = end - start;

    start = clock();
    ft_vec.insert(ft_it, buffer.begin(), buffer.end());
    end = clock();
    time(start, end);
    ft_ticks = end - start;
    ...
    start = clock();
    std_vec1.insert(++std_vec1.begin(), 10);
    end = clock();
    time(start, end);
    std_ticks = end - start;

    start = clock();
    ft_vec1.insert(++ft_vec1.begin(), 10);
    end = clock();
    time(start, end);
    ft_ticks = end - start;
...
void    constructor_test() {
    ft::vector<int> ft_vec(5, 123);
    ft::vector<int> std_vec(5, 123);

    std::cout << std_vec.size() << " " << ft_vec.size() << "\n";
    checker(std_vec.size() == ft_vec.size());
    checker(ft::equal(std_vec.begin(), std_vec.end(), ft_vec.begin()));
...
void throw_test() {
    ft::vector<Test> ft_v1;

    test_title("THROW TEST");
    for (size_t i = 0; i < ITERATIONS; i++) {
        ft_v1.push_back(Test());
    }
}
