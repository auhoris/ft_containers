...
void test_map_constructor_1_2(void) {
    std::cout << YELLOW "1.2) Default constructor [+ add + erase]:" DEFAULT
              << std::endl;
    std::map<int, long> smap;
    ft::map<int, long> fmap;
...
void test_map_constructor_2_1(void) {
    std::cout << YELLOW
        "2.1) Default constructor with compare + allocator :" DEFAULT
              << std::endl;
...
void test_map_constructor_2_2(void) {
    std::cout << YELLOW
        "2.2) Default constructor with allocator [+ add + erase]:" DEFAULT
              << std::endl;
...
void test_map_constructor_3_2(void) {
    std::cout << YELLOW "3.2) Range based constructor [+ push + pop]:" DEFAULT
              << std::endl;
...
void test_map_constructor_5_2(void) {
    std::cout << YELLOW "5.2) Copy constructor [empty + push + pop]:" DEFAULT
              << std::endl;
...
void test_map_constructor_5_3(void) {
    std::cout << YELLOW "5.3) Copy constructor [non-empty]:" DEFAULT
              << std::endl;
...
void test_map_constructor_5_4(void) {
    std::cout << YELLOW
        "5.4) Copy constructor [+ non-empty + push + pop]:" DEFAULT
              << std::endl;
...
void test_map_iterators_2_2(void) {
    std::cout << YELLOW "2.2) const_iterators [non-empty]:" DEFAULT
              << std::endl;
...
//     for (std::map<int, long>::iterator i = smap.begin(); i != smap.end();
//     ++i)
...
void test_map_rev_iterators_1_1(void) {
    ...
    for (std::map<int, long>::reverse_iterator i = smap.rbegin();
         i != smap.rend(); ++i)
        i->second = 0;

    for (ft::map<int, long>::reverse_iterator i = fmap.rbegin();
         i != fmap.rend(); ++i)
        i->second = 0;
...
void test_map_rev_iterators_1_2(void) {
    std::cout << YELLOW "1.2) reverse iterators [non-empty]:" DEFAULT
              << std::endl;
...
void test_map_rev_iterators_2_1(void) {
    std::cout << YELLOW "2.1) const_reverse_iterators [empty]:" DEFAULT
              << std::endl;

    std::map<int, long> smap;
    ft::map<int, long> fmap;

    for (std::map<int, long>::const_reverse_iterator i = smap.rbegin();
         i != smap.rend(); ++i)
        *i;

    for (ft::map<int, long>::const_reverse_iterator i = fmap.rbegin();
         i != fmap.rend(); ++i)
        *i;
...
void test_map_rev_iterators_2_2(void) {
    std::cout << YELLOW "2.2) const_reverse_iterators [non-empty]:" DEFAULT
              << std::endl;
...
//     for (std::map<int, long>::reverse_iterator i = smap.rbegin(); i !=
//     smap.rend(); ++i)
//         i->second = (int)std::distance(smap.rbegin(), i);

//     for (ft::map<int, long>::reverse_iterator i = fmap.rbegin(); i !=
//     fmap.rend(); ++i)
...
void test_map_equal_range() {
    ...
    std::pair<std::map<int, long>::iterator, std::map<int, long>::iterator>
        stmp_pair;
    ft::pair<ft::map<int, long>::iterator, ft::map<int, long>::iterator>
        ftmp_pair;
